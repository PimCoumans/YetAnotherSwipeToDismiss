...
public final class ShowTime: NSObject {
	...
	/// (`.always` by default)
	@objc public static var enabled: Enabled = .debugOnly
	...
	/// (`.standard` by default)
	public static var disappearAnimation: Animation = .scaleUp
	
	/// The delay, in seconds, before the visual touch disappears after a touch ends.
	/// (`0.2`s by default)
	@objc public static var disappearDelay: TimeInterval = 0
